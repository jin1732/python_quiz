# **Python과 Git으로 만드는 나만의 콘솔 퀴즈 게임(pull작성 수정)**
...
while True:
    ...
    try:
        ...
        break
```
- 실핼화면 : ![테스트 결과](./images/test3.png)
- 실핼화면 : ![테스트 결과](./images/test4.png)
...
- 실핼화면 : ![테스트 결과](./images/test7.png)
- 실핼화면 : ![테스트 결과](./images/test8.png)
